...
const contactInfo = [
  {
    icon: <EmailIcon className="text-primary w-6 h-6" />,
    label: "Email",
    value: "rahul.tech.info.500@gmail.com",
    href: "mailto:rahul.tech.info.500@gmail.com",
  },

  {
    icon: <LocationOnIcon className="text-primary w-6 h-6" />,
    label: "Location",
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                I'm open to new opportunities and exciting projects. Let's talk!
              </p>
            </div>
          </div>
        </div>
